    ...
    <asp:UpdatePanel runat="server" ChildrenAsTriggers="true">
        <ContentTemplate>
            ...
            <div class="form-group row justify-content-center bottom-space">
                ...
                <asp:LinkButton ID="ResetReport" runat="server" CssClass="button button-plain second-button report-btn" OnClick="ResetReport_Click" OnClientClick="return confirm('Resetting the filters will remove the current report. Do you want to continue?')">Reset Filters</asp:LinkButton>
            </div>
