    ...
    <asp:UpdatePanel runat="server" ChildrenAsTriggers="true" ID="UpdatePanel">
        <ContentTemplate>
            ...
            <div class="form-group row">
		        ...
		        <div class="col-sm-10">
                    <asp:DropDownList ID="CareSiteDDL" runat="server" AppendDataBoundItems="true" 
                            CssClass="form-control" DataSourceID="GetCareSitesODS" DataTextField="caresitename" DataValueField="caresiteid" OnSelectedIndexChanged="RetrieveUnitList_Select" AutoPostBack="true">
            ...
            <div class="form-group row" id="unitsdiv" runat="server">
		        <label id="UnitLable" for="UnitRepeater" class="col-sm-2 col-form-label right-text" runat="server">Unit</label>
		        <div class="col-sm-10">
	        ...
	        <div class="form-group row justify-content-center top-space bottom-space">
                <asp:LinkButton ID="RetrieveSurveysButton" runat="server" CssClass="button button-info report-btn" OnClick="RetrieveSurveys_Click">Retrieve Surveys</asp:LinkButton>
                <asp:LinkButton ID="ResetPage" runat="server" CssClass="button button-plain second-button report-btn" OnClick="ResetPage_Click" OnClientClick="return confirm('Resetting the filters will remove the current results. Do you want to continue?')">Reset Filters</asp:LinkButton>
	        </div>
		
	        <h3>Results: <asp:Label ID="ResultCountLabel" runat="server" Text="-" /></h3>

            <asp:Repeater ID="SurveyRepeater" runat="server" ItemType="MSS.Data.DTOs.ExtendedSurveyDTO">
