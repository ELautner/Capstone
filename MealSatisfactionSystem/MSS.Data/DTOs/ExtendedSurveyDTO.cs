...
namespace MSS.Data.DTOs
{
    ...
    ExtendedSurveyDTO
    Uses default "get" and "set" methods to access the Survey entity. The ExtendedSurveyDTO is used to act as a layer of protection and avoids direct modification of database entities.
    Also includes the unitname, caresitename and respondenttypename that are related to the Survey.
